...
namespace HoneyBack.Migrations
{
    ...
    [Migration("20260616153307_AddOnboardingUsuario")]
    partial class AddOnboardingUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HoneyBack.Models.OnboardingUsuario", b =>
                {
                    b.Property<int>("OnboardingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("OnboardingID");
                    ...
                    b.HasKey("OnboardingId")
                        .HasName("PK_OnboardingUsuarios");

                    b.HasIndex(new[] { "UsuarioId" }, "UQ_OnboardingUsuarios_Usuario")
                        .IsUnique();

                    b.ToTable("OnboardingUsuarios", (string)null);
                });
            ...
            modelBuilder.Entity("HoneyBack.Models.RegistroLogin", b =>
                {
                    b.Property<long>("RegistroLoginId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("RegistroLoginID");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("RegistroLoginId"));
                    ...
                    b.HasKey("RegistroLoginId")
                        .HasName("PK_RegistrosLogin");

                    b.HasIndex(new[] { "FechaLogin" }, "IDX_RegistrosLogin_Fecha");

                    b.HasIndex(new[] { "UsuarioId" }, "IDX_RegistrosLogin_Usuario");

                    b.HasIndex(new[] { "UsuarioId", "FechaLogin" }, "IDX_RegistrosLogin_Usuario_Fecha");

                    b.ToTable("RegistrosLogin", (string)null);
                });
